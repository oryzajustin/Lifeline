...
var Tab1Page = /** @class */ (function () {
    function Tab1Page(socket, platform, geolocation) {
        this.socket = socket;
    ...
    Tab1Page.prototype.addLocations = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var i, i;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(i < this.emsMarkers.length)) return [3 /*break*/, 4];
                    ...
                    case 4:
                        ...
                        _a.label = 5;
                    case 5:
                        if (!(i < this.hospitalMarkers.length)) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.map.addMarker({
    ...
    Tab1Page.prototype.loadMap = function () {
        ...
        this.geolocation.getCurrentPosition({ enableHighAccuracy: true }).then(function (resp) {
            ...
            _this.map = _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_3__["GoogleMaps"].create('map_canvas', {
                camera: {
                    target: {
            ...
            _this.socket.updateDistressSignals()
                .subscribe(function (signals) {
                console.log("New Update");
                console.log(signals);
                _this.map.clear();
                //populate data from london
                _this.addLocations().then(function () {
                    if (signals.length > 0) {
                        // Use only latest alert
                        _this.currentAlert = signals[signals.length - 1];
                        console.log(_this.currentAlert);
                        _this.gmapsLink = "https://www.google.com/maps/dir/?api=1&destination=" + _this.currentAlert.coords.lat + "," + _this.currentAlert.coords.lng;
                        ...
                        _this.map.addMarker({
                            ...
                            animation: 'DROP',
                            position: {
                                lat: _this.currentAlert.coords.lat,
                                lng: _this.currentAlert.coords.lng
                            }
                        }).then(function () {
                            _this.map.animateCamera({
                                target: { lat: _this.currentAlert.coords.lat, lng: _this.currentAlert.coords.lng },
                                zoom: 20,
                                tilt: 60,
                                bearing: 140,
                                duration: 5000
                        ...
                        _this.currentAlert = null;
                        _this.gmapsLink = null;
                    }
                });
            });
            _this.socket.emit("UpdateDistressSignals", null);
        }).catch(function (error) {
            console.log('Error getting location', error);
        });
    };
    Tab1Page.prototype.ResolveButton = function () {
